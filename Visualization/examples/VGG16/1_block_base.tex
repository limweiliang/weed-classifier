...
% Flatten
\pic[shift={(6,0,0)}] at (p2-east) {RightBandedBox={name=Flatten,caption=Flatten,%
...
\draw [connection]  (p2-east)        -- node {\midarrow} (Flatten-west);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\draw[densely dashed]
    (Flatten-east)++(0, 1.5*.2, 1.5*.2) coordinate(a) -- (p2-nearnortheast)
    (Flatten-east)++(0,-1.5*.2, 1.5*.2) coordinate(b) -- (p2-nearsoutheast)
    (Flatten-east)++(0,-1.5*.2,-1.5*.2) coordinate(c) -- (p2-farsoutheast)
    (Flatten-east)++(0, 1.5*.2,-1.5*.2) coordinate(d) -- (p2-farnortheast)
